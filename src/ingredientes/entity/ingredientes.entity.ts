...
export class IngredientesData {
    ...
    @OneToOne(() => RecetaSub1Data, recetaSub1 => recetaSub1.ingredientes)
    recetaSub1: RecetaSub1Data;

    @OneToOne(() => RecetaSub2Data, recetaSub2 => recetaSub2.ingredientes)
    recetaSub2: RecetaSub2Data;

    @OneToOne(() => RecetaSub3Data, recetaSub3 => recetaSub3.ingredientes)
